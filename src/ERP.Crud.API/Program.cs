        ...
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    ...
                    Version = "v1",
                    Description = "Servico responsavel pelo controle de lancamentos (debito e credito) e por enviar os dado para fila de mensagem para posterior consumo dos outros servicos",
                });
